          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="w-96 px-4 py-3 rounded-l-lg text-sm outline-none"
              />
              <button className="bg-coral text-white px-6 py-3 rounded-r-lg text-sm font-medium">
                Search
              </button>
            </div>
          </div>
        ...
        {!loading && totalPages > 1 && (
          <div className="flex justify-center gap-2 mt-8">
            <button
              ...
              className="px-4 py-2 text-sm border border-warmgray rounded-lg text-gray-500 hover:border-coral hover:text-coral disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
              ← Prev
            </button>
