      ...
      <div className="px-4 md:px-10 pt-12 pb-8 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-20">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <Link to="/" className="text-sm text-white/65 hover:text-white transition-colors">
              Venues
            </Link>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="/manager" className="text-sm text-white/65 hover:text-white transition-colors">
              Dashboard
            </Link>
            <Link to="/manager" className="text-sm text-white/65 hover:text-white transition-colors">
              View bookings
